package com.timenw.drinktracker
...
class MainActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            DrinkTrackerTheme(darkTheme = true) {
...
sealed class Screen(val route: String, val label: String, val selectedIcon: @Composable () -> Unit, val unselectedIcon: @Composable () -> Unit) {
    object Home : Screen("home", "饮酒", { Icon(Icons.Filled.LocalBar, contentDescription = null) }, { Icon(Icons.Outlined.LocalBar, contentDescription = null) })
